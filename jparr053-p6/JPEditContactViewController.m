...
@interface JPEditContactViewController ()
@property (strong, nonatomic) IBOutlet UIScrollView *scrollView;
@property (strong, nonatomic) IBOutlet UIView *contentView;

@end

@implementation JPEditContactViewController
...
- (void)viewDidLoad
{
    ...
    contactAddress.text = currentContact.address;
    contactPhoto.image = currentContact.photo;
